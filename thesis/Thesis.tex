...
%% ----- Abstract Page --------------------------------------------
  ...
  \abstract{
    \addtocontents{toc}{\vspace{1em}}  % Add a gap in the Contents, for aesthetics
    In the present work we propose an autonomous navigation sytem for aerial robotics. Based on the state of the art literature for localization, mapping and planning and the use of the Aerostack software platform we implement a system capable of executing navigation tasks in an autonomous way.
...
%% ----- Main Document --------------------------------------------
  ...
  \input{Chapters/Chapter1_Introduction.tex} % Introduction
  \input{Chapters/Chapter2_Problem_Description.tex} 
  \input{Chapters/Chapter3_State_Of_The_Art.tex}
  \input{Chapters/Chapter4_Implementation.tex} % Experimental Setup
  \input{Chapters/Chapter5_Validation.tex} % Validation of the experiments
  \input{Chapters/Chapter6_Conclusions.tex} % Conclusions and future reseach
  \backmatter
%% ----------------------------------------------------------------
%% ----- Bibliography ---------------------------------------------
  \label{Bibliography}
